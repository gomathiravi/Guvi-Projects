...
# upload to database
# students.upload_to_db(student_file_path)
# programming.upload_to_db(programming_file_path)
# soft_skills.upload_to_db(soft_skills_file_path)
# placements.upload_to_db(placements_file_path)